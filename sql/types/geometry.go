...
func (t GeometryType) Compare(context context.Context, a interface{}, b interface{}) (int, error) {
...
func (t GeometryType) Equals(ctx context.Context, otherType sql.Type) (ok bool) {
