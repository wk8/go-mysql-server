...
func (t TimespanType_) Compare(context context.Context, a interface{}, b interface{}) (int, error) {
...
func (t TimespanType_) Convert(ctx context.Context, v interface{}) (interface{}, sql.ConvertInRange, error) {
	if v == nil {
...
func (t TimespanType_) Equals(ctx context.Context, otherType sql.Type) bool {
