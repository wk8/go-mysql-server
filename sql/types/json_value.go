...
func StringifyJSON(ctx context.Context, jsonWrapper sql.JSONWrapper) (string, error) {
...
func (doc JSONDocument) ToInterface(interface{}) (interface{}, error) {
	return doc.Val, nil
}
...
func (j *LazyJSONDocument) ToInterface(interface{}) (interface{}, error) {
