...
func (t systemStringType) Convert(ctx context.Context, v interface{}) (interface{}, sql.ConvertInRange, error) {
	if v == nil {
...
func (t systemStringType) Equals(ctx context.Context, otherType sql.Type) bool {
