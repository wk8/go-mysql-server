...
type SystemVariable interface {
	...
	InitValue(ctx context.Context, val any, global bool) (SystemVarValue, error)
	...
	SetValue(ctx context.Context, val any, global bool) (SystemVarValue, error)
...
func (m *MysqlSystemVariable) InitValue(ctx context.Context, val any, global bool) (SystemVarValue, error) {
...
func (m *MysqlSystemVariable) SetValue(ctx context.Context, val any, global bool) (SystemVarValue, error) {
